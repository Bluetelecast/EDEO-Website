...
<div className="mt-[10rem] flex flex-col items-center pb-[3rem]">
 ...
 <section className="">
    <h2 className='p-1 pb-0 text-start text-3xl sm:text-5xl mt-[5rem] text-blue-500'>Education & Capacity Building Programs welfare</h2>
  ...
  <section className="">
    <h2 className='p-1 pb-0 text-start text-3xl sm:text-5xl mt-[5rem] text-blue-500'>Human Rights Promotion</h2>
    <p className="p-8 text-md text-start">Means to address the women right education from different perspectives, EDEO established a Human rights & documentation mechanism that performs several activities such as the documentation of human rights abuse afflicted on Women, children and affected relatives.</p>
  </section>

  <section className="">
    <h2 className='p-1 pb-0 text-start text-3xl sm:text-5xl mt-[5rem] text-blue-500'>Combating all forms of violence</h2>
    <p className="p-8 text-md text-start">
  ...
  <section className="">
    <h2 className='p-1 pb-0 text-start text-3xl sm:text-5xl mt-[5rem] text-blue-500'>Livelihood and Agriculture Program</h2>
    <p className="p-8 text-md text-start">
  ...
  <section className="">
    <h2 className='p-1 pb-0 text-start text-3xl sm:text-5xl mt-[5rem] text-blue-500'>Social Services, Health and Family Welfare</h2>
    <p className="p-8 text-md text-start">
