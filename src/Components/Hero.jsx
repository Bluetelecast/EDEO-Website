...
const Hero = ()=>{
    ...
    return (
        ...
        <h1 className="text-blue-950 font-sans p-5 font-bold text-start text-2xl sm:text-3xl md:text-4xl lg:text-5xl">Empowering Communities, Solving Real-World Problems.</h1>            
